...
import com.chrisandgib.afghani23.adapter.AdapterShoppingCart;
import com.chrisandgib.afghani23.connection.API;
import com.chrisandgib.afghani23.connection.RestAdapter;
import com.chrisandgib.afghani23.connection.callbacks.CallbackOrder;
import com.chrisandgib.afghani23.data.DatabaseHandler;
import com.chrisandgib.afghani23.data.SharedPref;
import com.chrisandgib.afghani23.model.BuyerProfile;
import com.chrisandgib.afghani23.model.Cart;
import com.chrisandgib.afghani23.model.Checkout;
import com.chrisandgib.afghani23.model.Info;
import com.chrisandgib.afghani23.model.Order;
import com.chrisandgib.afghani23.model.ProductOrder;
import com.chrisandgib.afghani23.model.ProductOrderDetail;
import com.chrisandgib.afghani23.utils.CallbackDialog;
import com.chrisandgib.afghani23.utils.DialogUtils;
import com.chrisandgib.afghani23.utils.Tools;
...
public class ActivityCheckout extends AppCompatActivity {
    ...
    private TextView total_order, tax, price_tax, total_fees, delivery;
    private TextInputLayout buyer_name_lyt, phone_lyt, address_lyt, comment_lyt;
    private EditText buyer_name, phone, address, comment;
    ...
    private void setTotalPrice() {
        ...
        int i=300;
        _total_fees = _total_order + _price_tax + i;
...
//        }
    ...
    private void submitOrderData() {
        ...
        SharedPref prefs =new SharedPref(this);
        String reg_id = prefs.getFcmRegId();
        Checkout checkout = new Checkout();
        ProductOrder productOrder = new ProductOrder(buyerProfile, shipping.getSelectedItem().toString(), date_ship_millis, comment.getText().toString().trim(),reg_id);
