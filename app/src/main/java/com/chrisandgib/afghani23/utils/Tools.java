package com.chrisandgib.afghani23.utils;
...
import static com.chrisandgib.afghani23.R.string.*;
...
public class Tools {
    ...
    public static void showDialogAbout(Activity activity) {
        Dialog dialog = new DialogUtils(activity).buildDialogInfo(title_about, content_about, OK, R.drawable.img_about, new CallbackDialog() {
            @Override
    ...
    public static String getVersionName(Context ctx) {
        try {
            PackageManager manager = ctx.getPackageManager();
            PackageInfo info = manager.getPackageInfo(ctx.getPackageName(), 0);
            return ctx.getString(app_version) + " " + info.versionName;
        } catch (PackageManager.NameNotFoundException e) {
            return ctx.getString(R.string.version_unknown);
        }
    }
    ...
    public static void copyToClipboard(Context context, String data) {
        ...
        Toast.makeText(context, msg_copied_clipboard, Toast.LENGTH_SHORT).show();
    }
